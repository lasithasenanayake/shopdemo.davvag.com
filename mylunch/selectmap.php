...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" href="assets/mylunch/img/favicon.png" />
        <title>Mylunch.lk - Please pick your location to proceeed</title>
        <style>
    ...
    <body>
        <div id="idContainer">
            <div id="idHeader" >
                <img src="assets/mylunch/img/cart.png">
